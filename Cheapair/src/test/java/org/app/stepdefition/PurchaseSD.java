...
public class PurchaseSD extends PurchaseExe {
	...
	@When("enter the middle name {string}")
	public void enter_the_middle_name(String string) {
		middleName(string);
	}
	...
	@When("select the suffix dropdown {string}")
	public void select_the_suffix_dropdown(String string) {
		suffix(string);
	}

	@Then("validate the suffix dropdown")
	public void validate_the_suffix_dropdown() {
		System.out.println("all suffix button are successful clickable");
	}
	...
	@When("enter the day of date of birth {string}")
	public void enter_the_day_of_date_of_birth(String string) {
		dayOfDOB(string);
	}

	@When("dropdown the month of date of birth {string}")
	public void dropdown_the_month_of_date_of_birth(String string) {
		monthOfDOB(string);
	}
